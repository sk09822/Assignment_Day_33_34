...
public class EmpDatabaseService {
    ...
    private static EmpDatabaseService employeePayrollDBService;

    private EmpDatabaseService() {

    }

    public static EmpDatabaseService getInstance() {

        if (employeePayrollDBService == null)

            employeePayrollDBService = new EmpDatabaseService();
    ...
    private List<EmpPayrollData> getEmployeeData(ResultSet resultSet) {
    ...
    public List<EmpPayrollData> getEmployeeData(String name) {
